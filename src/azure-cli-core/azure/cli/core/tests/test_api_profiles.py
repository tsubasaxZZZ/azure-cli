...
class TestAPIProfiles(unittest.TestCase):
    ...
    def test_get_api_version(self):
        ...
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            self.assertEqual(cli.cloud.get_api_version(ResourceType.MGMT_STORAGE), '2020-10-10')
    ...
    def test_get_api_version_invalid_rt(self):
        ...
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            with self.assertRaises(APIVersionException):
                cli.cloud.get_api_version(ResourceType.MGMT_COMPUTE)
    ...
    def test_get_api_version_invalid_active_profile(self):
        ...
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            with self.assertRaises(APIVersionException):
                cli.cloud.get_api_version(ResourceType.MGMT_STORAGE)
    ...
    def test_supported_api_version_invalid_profile_name(self):
        ...
        with self.assertRaises(ValueError):
            cli.cloud.supported_api_version(PROFILE_TYPE, min_api='2000-01-01')
    ...
    def test_supported_api_profile_min_constraint_not_supported(self):
        ...
        self.assertFalse(cli.cloud.supported_api_version(PROFILE_TYPE, min_api='2000-01-02'))

    def test_supported_api_profile_min_max_constraint(self):
        cli = TestCli()
        cli.cloud = Cloud('TestCloud', profile='2000-01-01-profile')
        self.assertTrue(cli.cloud.supported_api_version(PROFILE_TYPE, min_api='2000-01-01', max_api='2000-01-01'))

    def test_supported_api_profile_max_constraint_not_supported(self):
        cli = TestCli()
        cli.cloud = Cloud('TestCloud', profile='2000-01-01-profile')
        self.assertFalse(cli.cloud.supported_api_version(PROFILE_TYPE, max_api='1999-12-30'))

    def test_supported_api_profile_preview_constraint(self):
        cli = TestCli()
        cli.cloud = Cloud('TestCloud', profile='2000-01-01-profile')
        self.assertTrue(cli.cloud.supported_api_version(PROFILE_TYPE, min_api='2000-01-01-preview'))

    def test_supported_api_profile_preview_constraint_in_profile(self):
        cli = TestCli()
        cli.cloud = Cloud('TestCloud', profile='2000-01-01-profile-preview')
        self.assertFalse(cli.cloud.supported_api_version(PROFILE_TYPE, min_api='2000-01-01'))
    ...
    def test_supported_api_version_no_constraints(self):
        ...
        cli = TestCli()
        with self.assertRaises(ValueError):
            cli.cloud.supported_api_version(ResourceType.MGMT_STORAGE)
    ...
    def test_supported_api_version_min_constraint(self):
        ...
        test_profile = {'2017-01-01-profile': {ResourceType.MGMT_STORAGE: '2020-10-10'}}
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            self.assertTrue(cli.cloud.supported_api_version(ResourceType.MGMT_STORAGE, min_api='2000-01-01'))
    ...
    def test_supported_api_version_max_constraint(self):
        ...
        test_profile = {'2017-01-01-profile': {ResourceType.MGMT_STORAGE: '2020-10-10'}}
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            self.assertTrue(cli.cloud.supported_api_version(ResourceType.MGMT_STORAGE, max_api='2021-01-01'))
    ...
    def test_supported_api_version_min_max_constraint(self):
        ...
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            self.assertTrue(
                cli.cloud.supported_api_version(ResourceType.MGMT_STORAGE, min_api='2020-01-01', max_api='2021-01-01'))
    ...
    def test_supported_api_version_max_constraint_not_supported(self):
        ...
        test_profile = {'2017-01-01-profile': {ResourceType.MGMT_STORAGE: '2020-10-10'}}
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            self.assertFalse(cli.cloud.supported_api_version(ResourceType.MGMT_STORAGE, max_api='2019-01-01'))
    ...
    def test_supported_api_version_min_constraint_not_supported(self):
        ...
        test_profile = {'2017-01-01-profile': {ResourceType.MGMT_STORAGE: '2020-10-10'}}
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            self.assertFalse(cli.cloud.supported_api_version(ResourceType.MGMT_STORAGE, min_api='2021-01-01'))
    ...
    def test_supported_api_version_preview_constraint(self):
        ...
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            self.assertTrue(cli.cloud.supported_api_version(ResourceType.MGMT_STORAGE, min_api='2020-01-01'))
    ...
    def test_supported_api_version_invalid_rt_for_profile(self):
        ...
        with mock.patch('azure.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            with self.assertRaises(APIVersionException):
                cli.cloud.supported_api_version(ResourceType.MGMT_COMPUTE, min_api='2020-01-01')
